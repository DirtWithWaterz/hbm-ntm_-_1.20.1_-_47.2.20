...
public class HazardData {
	...
	public HazardData addEntry(HazardType hazard) {
		return this.addEntry(hazard, 1F, false);
	}
	
	public HazardData addEntry(HazardType hazard, float level) {
		return this.addEntry(hazard, level, false);
	}
	
	public HazardData addEntry(HazardType hazard, float level, boolean override) {
