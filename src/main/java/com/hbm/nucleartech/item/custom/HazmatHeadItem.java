...
public class HazmatHeadItem extends GasmaskItem {

	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

	public HazmatHeadItem(Properties s, ArmorMaterial material) {
		super(
				s,
				material,
				"hbm:textures/item/armor/hazmat.png",
				null,
				"animation.hazmat.no_filter",
				"animation.hazmat.filter"
		);
	}
