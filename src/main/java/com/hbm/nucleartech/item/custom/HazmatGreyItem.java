...
public class HazmatGreyItem extends ItemArmorMod implements GeoItem {

	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

	public HazmatGreyItem(Properties s, ArmorMaterial material, Type type) {
		super(
				s,
				material,
				type,
	...
	public @Nullable String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
		return "hbm:textures/item/armor/hazmat_grey.png";
	}
