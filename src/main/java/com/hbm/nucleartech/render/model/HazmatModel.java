...
public class HazmatModel extends GeoModel<HazmatHeadItem> {
    ...
    public ResourceLocation getModelResource(HazmatHeadItem item) {
        return ResourceLocation.fromNamespaceAndPath(HBM.MOD_ID, "geo/item/armor/hazmat.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(HazmatHeadItem item) {
        return ResourceLocation.fromNamespaceAndPath(HBM.MOD_ID, "textures/item/armor/hazmat.png");
    }

    @Override
    public ResourceLocation getAnimationResource(HazmatHeadItem item) {
        return ResourceLocation.fromNamespaceAndPath(HBM.MOD_ID, "animations/item/armor/hazmat.animation.json");
    }
}