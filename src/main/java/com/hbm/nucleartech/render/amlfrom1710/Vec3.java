...
public class Vec3
{
    ...
    {
        double d0 = (double) Mth.sqrt((float)(this.xCoord * this.xCoord + this.yCoord * this.yCoord + this.zCoord * this.zCoord));
    ...
    {
        return (double)Mth.sqrt((float)(this.xCoord * this.xCoord + this.yCoord * this.yCoord + this.zCoord * this.zCoord));
    }
    ...
    {
        float f1 = Mth.cos(p_72440_1_);
        float f2 = Mth.sin(p_72440_1_);
    ...
    {
        float f1 = Mth.cos(p_72442_1_);
        float f2 = Mth.sin(p_72442_1_);
    ...
    {
        float f1 = Mth.cos(p_72446_1_);
        float f2 = Mth.sin(p_72446_1_);
	...
	public  net.minecraft.world.phys.Vec3 toVec3d(){
     	return new net.minecraft.world.phys.Vec3(xCoord, yCoord, zCoord);
	}
